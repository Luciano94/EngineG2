...
bool Game::OnStart() {
	...
	spr2->LoadMaterial("sample2.bmp");
	spr2->SetPos(0, 10, 0);
	spr2->SetBoundingBox(2.0f, 2.0f, false);
...
bool Game::OnUpdate() {
	...
	spr2->Translate(0,-speed *  deltaTime * 2.0f, 0);
